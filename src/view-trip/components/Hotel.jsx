            ...
            <div className="grid lg:grid-cols-4 xl:grid-cols-4 gap-4">
                {trip?.tripData?.hotels?.map((hotel, index) => (
                    <div className="bg-gray-100 p-2 rounded-xl hover:shadow-lg" key={index}>
                        ...
                        <button
                            className="btun relative cursor-not-allowed opacity-70"
                            disabled
                            onClick={(e) => e.preventDefault()} // just to ensure it never fires
                        ...
                        <p className="text-xs text-gray-500 mt-1 mb-3">* Payment gateway is under development</p>
